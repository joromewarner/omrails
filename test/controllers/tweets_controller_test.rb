...
class TweetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tweet" do
    assert_difference('Tweet.count') do
      post tweets_url, params: { tweet: { context: @tweet.context, user_id: @tweet.user_id } }
    end
  ...
  test "should update tweet" do
    patch tweet_url(@tweet), params: { tweet: { context: @tweet.context, user_id: @tweet.user_id } }
